...
function encryptData(data) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].sign(data, key, {
        algorithm: 'HS256'
    });
}
function decryptData(token) {
    const key = process.env.BASE_POBLACIONAL_ENCRYPT_KEY || '';
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].verify(token, key);
}
async function getDataPatient(documento) {
    ...
    try {
        ...
        if (res.status !== 200) {
            throw new Error('No se logro encontrar la información solicitada');
        }
        ...
        return {
            failed: true,
            message: "No se logro encontrar la información solicitada"
        };
    }
}
;
...
//# sourceMappingURL=_dc935e._.js.map