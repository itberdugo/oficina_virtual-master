        ...
        <>
            ...
            <main className="w-3/4 flex items-center justify-center mt-24">
                ...
                <section className="grid grid-cols-4 w-full gap-2" >
                    ...
                    {/* TODO: Validar la eliminación de este link el cual estaba redireccionando inicialmente a la pagina https://oficinavirtual.bienestarips.com/www/aliansalud/oficinavirtual/login */}

                    {/* <Link href={"https://oficinavirtual.bienestarips.com/www/aliansalud/oficinavirtual/login"} target="_blank" className="w-3/4  flex flex-col gap-5 p-5 border-primary-aliansalud border-2 
                    ...
                    <Link href={"/agendar-cita"} className="w-3/4  flex flex-col gap-5 p-5 border-primary-aliansalud border-2 
                        rounded-lg cursor-pointer transform transition-transform duration-300 hover:scale-110">
                    ...
                    <Link href={"https://oficinavirtual.bienestarips.com/www/aliansalud/oficinavirtual/login"}
                        target="_blank" className="w-3/4  flex flex-col gap-5 p-5 border-primary-aliansalud border-2 rounded-lg 
